...
function resourceValue(resource, options) {
    ...
    if (typeof resource === 'object') {
        ...
        if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.isNullOrEmpty)(lang)) {
            const resValue = (_d = (_c = (_b = resource === null || resource === void 0 ? void 0 : resource.values) === null || _b === void 0 ? void 0 : _b[lang]) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : '';
            // @ts-ignore
...
function htmlEncode(value, options) {
