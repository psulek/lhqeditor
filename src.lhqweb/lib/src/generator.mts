import { isNullOrEmpty } from './utils.mjs';
import { AppError } from './AppError.mjs';
import { RootModelElement } from './model/rootModelElement.mjs';
...
import { HbsTemplateManager } from './hbsManager.mjs';
import { DefaultCodeGenSettings } from './model/modelConst.mjs';
import type { CodeGeneratorBasicSettings } from './api/modelTypes.mjs';
import type { GeneratedFile, GenerateResult } from './api/types.mjs';
import { GeneratorInitialization, IHostEnvironment } from './types.mjs';
import { LhqModel } from './api/schemas.mjs';
import { validateLhqModel } from './generatorUtils.mjs';
...
export class Generator {
     ...
     */
    public generate(fileName: string, model: LhqModel, hostData?: Record<string, unknown>): GenerateResult {
        if (!Generator._initialized) {
