...
type defaultValuesHelperArgs = {
    /**
     * default value to return when queryObjValue returns undefined/null or '' (when hash "defaultOnEmpty" is "true")
     */
    default?: unknown;

    /**
     * return default value when queryObjValue returns '' (extending default behavior of checking for undefined/null).
     * @default false
     */
