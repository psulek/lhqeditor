import { isNullOrEmpty, iterateObject, sortObjectByKey, sortObjectByValue, trimComment } from '../utils.mjs';
import { ResourceParameterElement } from './resourceParameterElement.mjs';
import { ResourceValueElement } from './resourceValueElement.mjs';
import type { LhqModelResource, LhqModelResourceTranslationState } from '../api/schemas.mjs';
import type { IResourceElement, IResourceParameterElement, IResourceValueElement, IRootModelElement, ICategoryLikeTreeElement } from '../api/modelTypes.mjs';
