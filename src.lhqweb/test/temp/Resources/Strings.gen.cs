...
namespace test123q
{
	...
	public class StringsLocalizer : IStringLocalizer
	{
		...
		{
			return new ResourceManager("test123q.Resources.Strings",
					typeof(test123q.Strings).GetTypeInfo().Assembly);
		}
	...
	public partial class Strings
	{
		...
		/// Gets localized string similar to: Welcome {0} in this {1} !
		/// </summary>
		public static string Welcome(object user,object app) => _localizer[StringsKeys.Welcome, user,app];
