...
namespace Template.AspNetCore.MVC.NET6
{
	using System;
    ...
    public class StringsModelLocalizer : IStringLocalizer
    {
		...
		{
		    return new ResourceManager("Template.AspNetCore.MVC.NET6.Resources.StringsModel",
				    typeof(Template.AspNetCore.MVC.NET6.StringsModel).GetTypeInfo().Assembly);
		}
